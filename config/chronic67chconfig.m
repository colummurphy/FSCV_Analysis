...
ncsnoartifacts={'cl1'};          %for interpolation
...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic67_05112018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,patra_ephys,'2018-05-11_10-50-42',filesep);
