...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic90_06192018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-06-19_10-23-42',filesep);
