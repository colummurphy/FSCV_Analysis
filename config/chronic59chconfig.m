...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic59_04302018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-04-30_11-30-08',filesep);
