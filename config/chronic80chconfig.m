...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic80_06012018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-06-01_11-00-31',filesep);
