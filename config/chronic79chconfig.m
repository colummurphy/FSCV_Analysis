...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic79_05312018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-05-31_08-38-00',filesep);
