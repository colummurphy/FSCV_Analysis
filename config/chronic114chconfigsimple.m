...
paths{1}=fullfile(letterdrive,'data_MIT',fscvdir,'patra_chronic114_07262018','1dr','cvtotxt',filesep);
%paths{2}=fullfile(homedir,graserver,'patra2','2018-07-26_10-51-56',filesep);
