...
resort=[];
badChannels=[];
parameters.absthres=1;      %flag use abs thres hold or peakDiff below
...
parameters.glitchThres=3;       %

parameters.badoverlap=[1 1];      %-/+ # of fscv samples around artifact to devalidate for peaks
%ie
