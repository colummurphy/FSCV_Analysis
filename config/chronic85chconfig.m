...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic85_06122018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-06-12_09-43-22',filesep);
