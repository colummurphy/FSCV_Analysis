...
ncschannels={'p1','p2','p3','p1-p2','p2-p3','p1-p3','pl2','pl2-p1','pl3','pl2-pl3',...
    'p1-pl3','p2-pl3','cl1','cl4','cl1-cl4',...
    'cl5','cl4-cl5','cl1-cl5','s2','s3','s3-s2','s4','s4-s3',...
...
%s3 good
%s4,s5,s6 no good
ncschannels={'p1-p3','pl2-p1','p1-pl3','pl2-pl3','cl1-cl4','cl4-cl5','cl1-cl5',...
...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic58_04272018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-04-27_09-38-23',filesep);
