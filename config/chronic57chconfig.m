...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic57_04262018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-04-26_10-53-29',filesep);
