...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic86_06132018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-06-13_10-39-37',filesep);
