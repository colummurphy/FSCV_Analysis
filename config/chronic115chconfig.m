...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic115_07272018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-07-27_09-35-56',filesep);
