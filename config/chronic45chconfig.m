...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic45_03292018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-03-29_10-07-14',filesep);