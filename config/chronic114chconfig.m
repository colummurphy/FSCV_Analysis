...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic114_07262018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,patra_ephys,'2018-07-26_10-51-56',filesep);
