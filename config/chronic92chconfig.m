...
ncschannels={'p1','p2','p1-p2','p5','p2-p5','p1-p5','pl1','pl1-p5','pl1-p1',...
    'cl1','cl1-cl4','cl3','cl1-cl3','cl4','cl3-cl4'...
    'cl6','cl4-cl6','cl3-cl6',...
...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic92_06212018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-06-21_10-34-09',filesep);