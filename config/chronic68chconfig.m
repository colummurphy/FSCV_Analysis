...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic68_05142018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,'patra2','2018-05-14_13-22-49',filesep);
