...
paths{1}=fullfile(homedir,graserver,fscvdir,'patra_chronic113_07252018','1dr','cvtotxt',filesep);
paths{2}=fullfile(homedir,graserver,patra_ephys,'2018-07-25_11-06-05',filesep);
