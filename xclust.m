...
dabase=xcovdata{ilfp}.daavgstds;
...
for ii=1:size(dawin,1)
    ...
    for iparam=1:length(params)
        ...
        xinfo(ilfp)=setfield(xinfo(ilfp),'daall',params{iparam},{ii},storevalue);
    end
...
dagroups={'daall'};         %no more separate groups, since indicated in trials anyways
