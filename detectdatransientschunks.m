...
%01/29/2019, updating getpctdirect, autotrialdir, to include M no bg
%need to update below to remove KBG, now cts only 3 rwos
...
%%%Maybe take out since we already check for glitches
        ...
        if abs(rmaxph)>parameters.RThresOut 
            continue
        end
