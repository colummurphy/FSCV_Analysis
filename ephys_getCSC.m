function [samples, fileNames, TS]=ephys_getCSC(chnums, sessiondir)
...
TS=lfp_SamplePeriod.*(1:length(samples{1}));        
TS=TS+lfp_TimeStamps(1);        %previous to 10/2018 just assumed first time stamp was accurate to use as reference for entire recording
