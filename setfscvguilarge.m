function setfscvguilarge(fh,numcolor)
...
for ifig=1:numcolor
    set(hgui.hfig{ifig}, 'Units','Pixels','Position',  ...
        [xoff hpos{ifig}(2)-yoff*(ifig-1)-yinitialoff ...
...
set(hgui.itplot, 'Units','Pixels','Position',  ...
    [xoff hposit(2)-yoff*(numcolor)-yinitialoff ...
    plotsize(1) plotsize(2)]);
itpos=get(hgui.itplot,'position');
    
%cv plot hgui.cv
set(hgui.cv, 'Units','Pixels','Position',  ...
    [hpos{1}(1)+plotsize(1)+xoff hposcv(2)+10 plotsize(1) plotsize(2)]);
...
set(hgui.closeup{1}, 'Units','Pixels','Position',  ...
    [hpos{1}(1)+plotsize(1)+xmarg itpos(2)+plotsize(2)*2+ymarg*2 plotsize(1) plotsize(2)]);
set(hgui.closeup{2}, 'Units','Pixels','Position',  ...
    [hpos{1}(1)+plotsize(1)+xmarg itpos(2)+plotsize(2)+ymarg plotsize(1) plotsize(2)]);
set(hgui.closeup{3}, 'Units','Pixels','Position',  ...
    [hpos{1}(1)+plotsize(1)+xmarg itpos(2) plotsize(1) plotsize(2)]);
closeuppos=get(hgui.closeup{1},'position');
%title text
...
for ich=1:numcolor
    ...
    checktxt = uicontrol('Style', 'text','string',chlab,...
        'Position', [hpos{ich}(1)-76 hpos{ich}(2)+plotsize(2)-15 20 15],...
...
hgui.blsub = uicontrol('Style', 'checkbox','value',plotParam.blsub,... 
   ...
   'backgroundcolor',[1 1 1]); 
textlogscale = uicontrol('Style', 'text',...
   'String', 'log v^2',...
   'Position', [figpos(3)-60 ...
   hposcloseup{1}(2)+plotsize(2)-70 65 25],...
   'BackgroundColor', [ 1 1 1]);
...
set(hgui.fftplot, 'Units','Pixels','Position',  ...
    [hpos{1}(1)+plotsize(1)+xmarg closeuppos(2)+plotsize(2)+ymarg plotsize(1) fftsize(2)]);
