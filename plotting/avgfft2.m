function evffts=avgfft2(data,fs,plotparam,hax,seltrials,varargin)
evffts={};
fontsize=14;
plotnum=0;
...
ecount=0;       %# events with markers supplied
...
while argnum <= length(varargin)
    switch varargin{argnum}     
        ...
        case 'events'
            ...
            ecount=ecount+1;
            argnum=argnum+1;
            eventtypes{ecount}=varargin{argnum};    %event label
            argnum=argnum+1;
            events{ecount}=varargin{argnum};        %fscv ts's
        case 'cscale'
            argnum=argnum+1;
