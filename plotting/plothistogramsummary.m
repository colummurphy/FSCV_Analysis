function plothistogramsummary(sessids,xinfo,dasite,plotparam,varargin)
...
if plotci 
    plotshaded(axa,tsplot,([-daci; daci]+daavg)',mark(itype,:));
...
if plotse
    plotshaded(axa,tsplot,([-dase; dase]+daavg)',mark(itype,:));
end    
